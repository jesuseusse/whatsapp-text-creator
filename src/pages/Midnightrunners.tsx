...
function Midnightrunnes() {
	...
	return (
		<Container>
			...
			{Object.keys(fields).map(fieldName => {
				if (fieldName.includes('divider'))
					return (
						<Divider>
							<Typography>{fields[fieldName]}</Typography>
						</Divider>
					);
				return (
					<TextField
